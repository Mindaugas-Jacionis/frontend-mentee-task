...
export default function authReducer(state = INITIAL_STATE_AUTH, { type, payload }) {
  ...
  switch (type) {
    ...
    case types.AUTH_SUCCESS:
          return Immutable.merge(state, {isLogged: true, token: payload.token, isFetching: false});
